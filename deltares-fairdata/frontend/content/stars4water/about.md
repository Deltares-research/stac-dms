...
2. Search the Stars4Water Catalog
   - Use the Search Bar at the top left to find datasets by keywords, topics, or geographic areas.
   - Use the map and draw a polygon on the map to search for datasets in the specific area
   - Apply filters (e.g., topic, keyword, date) to refine your results.

3. Browse by Topics/Categories
   - Navigate through predefined topics/categories such as *Hydrology*, *Climate*, and *Water Quality* for structured browsing.
