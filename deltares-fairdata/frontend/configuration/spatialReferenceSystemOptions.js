/**
 * Spatial reference system options for dataset registration
 * Modify this file to add, remove, or change spatial reference system options
 */
export const spatialReferenceSystemOptions = [
