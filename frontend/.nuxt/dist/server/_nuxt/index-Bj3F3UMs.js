...
import { b as useRouter, u as useNuxtApp, d as useApi, a as _sfc_main$1, _ as __nuxt_component_0 } from "../server.mjs";
import { defineComponent, ref, withAsyncContext, withCtx, createTextVNode, createVNode, unref, h, useSSRContext } from "vue";
    ...
    const collectionColumns = [
      ...
      },
      {
        ...
        cell: ({ row }) => {
          ...
          if (links === void 0) return "No keywords";
          const keywordDescription = keywords.value.find(
            (item) => item.id == links.id
          );
          if (keywordDescription === void 0) return "No keywords";
...
//# sourceMappingURL=index-Bj3F3UMs.js.map
