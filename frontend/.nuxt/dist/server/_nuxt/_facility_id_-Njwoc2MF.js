import { defineComponent, withCtx, unref, createVNode, useSSRContext, mergeProps, renderSlot, computed, withAsyncContext, createTextVNode, toDisplayString, openBlock, createBlock, Fragment, renderList } from "vue";
import { ssrRenderAttrs, ssrRenderComponent, ssrInterpolate, ssrRenderSlot, ssrRenderList } from "vue/server-renderer";
import { u as useNuxtApp, t as toast, n as navigateTo, a as _sfc_main$d, e as cn, d as useApi, c as useRoute } from "../server.mjs";
import { useForm, Field } from "vee-validate";
import { Trash2, X, ChevronDown, Check, ChevronUp, CheckIcon } from "lucide-vue-next";
import { _ as _sfc_main$e, b as _sfc_main$f, a as _sfc_main$g, c as _sfc_main$h } from "./FormMessage-DwFGFzr-.js";
...
import { z } from "zod";
import { _ as _sfc_main$i } from "./Input-BDNolIqX.js";
import "ofetch";
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_FormItem = _sfc_main$e;
      const _component_FormLabel = _sfc_main$f;
      const _component_Select = _sfc_main$a;
      const _component_FormControl = _sfc_main$g;
      ...
      const _component_FormMessage = _sfc_main$h;
      const _component_Button = _sfc_main$d;
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    let form = useForm({
      ...
      initialValues: {
        name: __props.facility.name ?? void 0
      }
    });
    form.handleSubmit(async (values) => {
      ...
      await $api(`/facility/{facility_id}`, {
        ...
        path: {
          ...
          facility_id: __props.facility.id ?? ""
        }
      });
      toast({
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_FormField = Field;
      const _component_FormItem = _sfc_main$e;
      const _component_Input = _sfc_main$i;
      const _component_Button = _sfc_main$d;
...
//# sourceMappingURL=_facility_id_-Njwoc2MF.js.map
