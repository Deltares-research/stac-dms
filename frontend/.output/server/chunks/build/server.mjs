import { hasInjectionContext, inject, version, unref, defineComponent, provide, shallowReactive, h, ref, watch, Suspense, nextTick, Fragment, Transition, computed, useSSRContext, mergeProps, withCtx, renderSlot, getCurrentInstance, resolveComponent, createTextVNode, toDisplayString, isVNode, createVNode, resolveDynamicComponent, openBlock, createBlock, createCommentVNode, renderList, withAsyncContext, createApp, effectScope, reactive, getCurrentScope, toValue, onErrorCaptured, onServerPrefetch, toRef, shallowRef, defineAsyncComponent, isReadonly, isRef, isShallow, isReactive, toRaw } from 'vue';
import { $ as $fetch$1, l as hasProtocol, m as isScriptProtocol, n as joinURL, w as withQuery, o as defu, p as sanitizeStatusCode, q as parseQuery, r as createHooks, h as createError$1, t as hash, v as withTrailingSlash, x as withoutTrailingSlash, y as toRouteMatcher, z as createRouter$1 } from '../runtime.mjs';
...
import { Primitive, useForwardPropsEmits, ToastRoot, ToastViewport, ToastClose, ToastTitle, ToastDescription, ToastProvider } from 'radix-vue';
...
const _routes = [
  {
    name: "admin",
    path: "/admin",
    component: () => import('./admin-Cvz44yTL.mjs')
  },
  {
    name: "collections-create",
    path: "/collections/create",
    component: () => import('./create-CSeTrxMo.mjs')
  },
  {
    name: "collections-delete-id",
    path: "/collections/delete/:id()",
    component: () => import('./_id_-DD8-MH_V.mjs')
  },
  {
    name: "collections",
    path: "/collections",
    component: () => import('./index-Bj3F3UMs.mjs')
  },
  {
    name: "collections-update-id",
    path: "/collections/update/:id()",
    component: () => import('./_id_-DdC4RSnB.mjs')
  },
  {
    name: "geometry",
    path: "/geometry",
    component: () => import('./geometry-CAlF_idO.mjs')
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-DZwlCMii.mjs')
  },
  {
    name: "items-id",
    path: "/items/:id()",
    component: () => import('./_id_-XwGJnZ6s.mjs')
  },
  {
    name: "items-delete-id",
    path: "/items/delete/:id()",
    component: () => import('./_id_-DO6kJuQb.mjs')
  },
  {
    name: "items",
    path: "/items",
    component: () => import('./index-BiFWa9Ui.mjs')
  },
  {
    name: "keywords",
    path: "/keywords",
    component: () => import('./keywords-DyA04rkd.mjs'),
    children: [
      {
        name: "keywords-facilities",
        path: "facilities",
        component: () => import('./facilities-D9uBav9y.mjs'),
        children: [
          {
            name: "keywords-facilities-facility_id",
            path: ":facility_id()",
            component: () => import('./_facility_id_-Njwoc2MF.mjs')
          }
        ]
      },
      {
        name: "keywords-groups",
        path: "groups",
        component: () => import('./groups-DTNrwj_H.mjs'),
        children: [
          {
            name: "keywords-groups-group_id",
            path: ":group_id()",
            component: () => import('./_group_id_-Bpld7hLP.mjs')
          }
        ]
      }
    ]
  },
  {
    name: "view",
    path: "/view",
    component: () => import('./view-B6yF56hh.mjs')
  }
];
...
function createOpenFetch(options, localFetch) {
  return (url, opts) => {
    ...
    const $fetch2 = getFetch(url, opts, localFetch);
    return $fetch2(fillPath(url, opts == null ? void 0 : opts.path), opts);
  };
}
...
const nuxt_plugin_RZGiRwB5P6 = /* @__PURE__ */ defineNuxtPlugin({
  enforce: "pre",
  setup() {
    const clients = (/* @__PURE__ */ useRuntimeConfig()).public.openFetch;
    const $fetch2 = useRequestFetch();
    return {
      provide: Object.entries(clients).reduce((acc, [name, client]) => ({
        ...acc,
        [name]: createOpenFetch(client, $fetch2)
      }), {})
    };
  }
});
...
function createUseOpenFetch(client, lazy = false) {
  return (url, options = {}, autoKey) => {
    const nuxtApp = useNuxtApp();
    const $fetch2 = nuxtApp[`$${client}`];
    const opts = { $fetch: $fetch2, key: autoKey, ...options };
    return useFetch(() => toValue(url), lazy ? { ...opts, lazy } : opts, "$BZE5gjfY7Y");
  };
}
const useApi = createUseOpenFetch("api");
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const {
      ...
      refresh
    } = ([__temp, __restore] = withAsyncContext(() => useApi("/auth/me", { credentials: "include" }, "$siNM9WAguS")), __temp = await __temp, __restore(), __temp);
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_Toaster = _sfc_main$a;
      _push(`<!--[--><div class="grid grid-cols-2 py-2 px-4 border-b border-border"><nav class="flex">`);
      ...
      if (!unref(notAuthenticated)) {
        _push(ssrRenderComponent(unref(_sfc_main$3), {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(ssrRenderComponent(_component_NuxtLink, { to: "/items" }, {
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`Register`);
                  } else {
      ...
      if (!unref(notAuthenticated)) {
        _push(ssrRenderComponent(unref(_sfc_main$3), {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(ssrRenderComponent(_component_NuxtLink, { to: "/admin" }, {
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`Admin`);
                  } else {
              ...
              return [
                createVNode(_component_NuxtLink, { to: "/admin" }, {
                  default: withCtx(() => [
                    createTextVNode("Admin")
                  ]),
                  _: 1
      ...
      if (!unref(notAuthenticated)) {
        _push(ssrRenderComponent(unref(_sfc_main$3), {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(ssrRenderComponent(_component_NuxtLink, { to: "/keywords" }, {
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`Keywords`);
                  } else {
              ...
              return [
                createVNode(_component_NuxtLink, { to: "/keywords" }, {
                  default: withCtx(() => [
                    createTextVNode("Keywords")
                  ]),
                  _: 1
      ...
      _push(ssrRenderComponent(unref(_sfc_main$3), {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_NuxtLink, { to: "/main" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`Storage Finder`);
                } else {
                  return [
                    createTextVNode("Storage Finder")
                  ];
                }
              }),
              _: 1
            ...
            return [
              createVNode(_component_NuxtLink, { to: "/main" }, {
                default: withCtx(() => [
                  createTextVNode("Storage Finder")
                ]),
                _: 1
      ...
      _push(`</nav><div class="flex justify-end"><nav class="flex">`);
      if (unref(notAuthenticated)) {
        _push(ssrRenderComponent(unref(_sfc_main$3), { variant: "link" }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<a href="/api/auth/login"${_scopeId}> Login</a>`);
            } else {
              return [
                createVNode("a", { href: "/api/auth/login" }, " Login")
              ];
            }
          }),
          _: 1
      ...
      if (unref(data)) {
        _push(ssrRenderComponent(unref(_sfc_main$3), {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(ssrRenderComponent(unref(User), { class: "w-4 h-4 mr-2" }, null, _parent2, _scopeId));
              _push2(` ${ssrInterpolate(unref(data).display_name)} Logout `);
            } else {
              return [
                createVNode(unref(User), { class: "w-4 h-4 mr-2" }),
                createTextVNode(" " + toDisplayString(unref(data).display_name) + " Logout ", 1)
              ];
            }
          }),
          _: 1
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-Db3mHLoY.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-MwCOS36A.mjs'));
...
export { __nuxt_component_0 as _, _sfc_main$3 as a, useRouter as b, useRoute as c, useApi as d, entry$1 as default, cn as e, buttonVariants as f, useToast as g, __nuxt_component_7 as h, injectHead as i, navigateTo as n, resolveUnrefHeadInput as r, toast as t, useNuxtApp as u, valueUpdater as v };
