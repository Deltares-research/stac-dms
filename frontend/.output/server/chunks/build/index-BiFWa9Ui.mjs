...
import { d as useApi, b as useRouter, a as _sfc_main$3, _ as __nuxt_component_0 } from './server.mjs';
import { defineComponent, withAsyncContext, mergeProps, withCtx, createTextVNode, createVNode, unref, openBlock, createBlock, createCommentVNode, useSSRContext, h } from 'vue';
    ...
    const collectionColumns = [
      {
        ...
        cell: ({ row }) => {
          var _a;
          return (_a = h("div", { class: "lowercase" }, row.original.properties.title)) != null ? _a : "";
        }
      },
      {
        ...
        cell: ({ row }) => {
          ...
          return h(
            "div",
            { class: "lowercase" },
            (_a = row.original.properties.description) != null ? _a : ""
          );
        }
      },
      {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  return [
                    ...
                    createVNode("div", { class: "flex justify-end" }),
                    unref(items).features ? (openBlock(), createBlock(_sfc_main$1, {
                      key: 0,
                      columns: collectionColumns,
                      data: unref(items).features,
                      filterId: "properties.title"
...
//# sourceMappingURL=index-BiFWa9Ui.mjs.map
