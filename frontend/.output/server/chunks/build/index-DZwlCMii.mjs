import { _ as _sfc_main$g } from './Checkbox-C_ItKoAB.mjs';
import { c as useRoute, d as useApi, e as cn, f as buttonVariants, a as _sfc_main$3$1, _ as __nuxt_component_0 } from './server.mjs';
import { _ as __nuxt_component_10 } from './client-only-D4CG9A2g.mjs';
import { useSSRContext, defineComponent, ref, computed, resolveComponent, mergeProps, unref, isRef, withCtx, createTextVNode, toDisplayString, createVNode, openBlock, createBlock, createCommentVNode, renderSlot, watch, Fragment, renderList, mergeModels, useModel, withAsyncContext } from 'vue';
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderAttr, ssrRenderList, ssrInterpolate, ssrRenderSlot, ssrRenderClass } from 'vue/server-renderer';
import { _ as _sfc_main$2$1, a as _sfc_main$1$1, b as _sfc_main$c } from './CardTitle-Bcq778cP.mjs';
import { _ as _sfc_main$d } from './CardDescription-5Vd1PiTP.mjs';
import { _ as _sfc_main$e } from './CardContent-BLyPnbSA.mjs';
...
import { _ as _sfc_main$8$1, a as _sfc_main$7$1, b as _sfc_main$6$1, c as _sfc_main$5$1, d as _sfc_main$2$2, e as _sfc_main$4$1, f as _sfc_main$f, g as _sfc_main$3$2, h as _sfc_main$1$2 } from './CommandList-CfKjBZrS.mjs';
import { _ as _sfc_main$b } from './Input-BDNolIqX.mjs';
...
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(unref(_sfc_main$8$1), _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(unref(_sfc_main$7$1), { "as-child": "" }, {
            ...
            _push2(ssrRenderComponent(unref(_sfc_main$6$1), { class: "w-auto p-0" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
            ...
            return [
              createVNode(unref(_sfc_main$7$1), { "as-child": "" }, {
                default: withCtx(() => [
                  createVNode(unref(_sfc_main$3$1), {
                    variant: "outline",
                    class: unref(cn)(
              ...
              createVNode(unref(_sfc_main$6$1), { class: "w-auto p-0" }, {
                default: withCtx(() => [
                  createVNode(unref(RangeCalendarRoot), {
                    modelValue: value.value,
                    "onUpdate:modelValue": ($event) => value.value = $event,
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(unref(_sfc_main$8$1), {
        open: unref(open),
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(unref(_sfc_main$6$1), { class: "p-0 PopoverContent" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                            ...
                            if (_push5) {
                                  ...
                                  default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                    if (_push6) {
                                      ...
                                      ssrRenderList(group.keywords, (keyword) => {
                                        _push6(ssrRenderComponent(unref(_sfc_main$1$2), {
                                          key: keyword.id,
                                          value: keyword.id,
                                          onSelect: (ev) => {
                                      ...
                                      return [
                                        (openBlock(true), createBlock(Fragment, null, renderList(group.keywords, (keyword) => {
                                          return openBlock(), createBlock(unref(_sfc_main$1$2), {
                                            key: keyword.id,
                                            value: keyword.id,
                                            onSelect: (ev) => {
                                              if (typeof ev.detail.value === "string") {
                              ...
                              return [
                                (openBlock(true), createBlock(Fragment, null, renderList(unref(keywordGroups), (group) => {
                                  return openBlock(), createBlock(unref(_sfc_main$3$2), null, {
                                    default: withCtx(() => [
                                      (openBlock(true), createBlock(Fragment, null, renderList(group.keywords, (keyword) => {
                                        return openBlock(), createBlock(unref(_sfc_main$1$2), {
                                          key: keyword.id,
            ...
            return [
              ...
              createVNode(unref(_sfc_main$6$1), { class: "p-0 PopoverContent" }, {
                default: withCtx(() => [
                  createVNode(unref(_sfc_main$5$1), null, {
                    default: withCtx(() => [
                      createVNode(unref(_sfc_main$2$2), {
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    let keywordIds = computed(() => {
      if (!route || !route.query || !route.query.keywords)
        return [];
    ...
    let collectionIds = computed(() => {
      if (!route || !route.query || !route.query.collections)
        return [];
            ...
            args: [
              {
                ...
                args: [
                  ...
                  `%${(_a2 = (_b = route.query) == null ? void 0 : _b.q) != null ? _a2 : ""}%`
                ]
              },
              {
                op: "like",
                args: [
                  ...
                  `%${(_b2 = (_c = route.query) == null ? void 0 : _c.q) != null ? _b2 : ""}%`
                ]
              }
            ]
          },
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_Checkbox = _sfc_main$g;
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(ssrRenderComponent(unref(_sfc_main$1$1), null, {
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(ssrRenderComponent(unref(_sfc_main$c), { class: "text-xl" }, {
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        var _a2, _b2;
                        if (_push4) {
                          _push4(`${ssrInterpolate((_a2 = item.properties.title) != null ? _a2 : item.id)}`);
                        } else {
                          return [
                            createTextVNode(toDisplayString((_b2 = item.properties.title) != null ? _b2 : item.id), 1)
                          ];
                        }
                      }),
                      _: 2
                    ...
                    return [
                      createVNode(unref(_sfc_main$c), { class: "text-xl" }, {
                        default: withCtx(() => {
                          var _a2;
                          return [
                            createTextVNode(toDisplayString((_a2 = item.properties.title) != null ? _a2 : item.id), 1)
                          ];
                        }),
                        _: 2
                      }, 1024),
              ...
              return [
                ...
                item.properties.datetime ? (openBlock(), createBlock(unref(_sfc_main$e), { key: 0 }, {
                  default: withCtx(() => [
                    createVNode(_component_NuxtLink, {
                      to: "/items/" + item.id + "?readonly=true"
                    }, {
...
//# sourceMappingURL=index-DZwlCMii.mjs.map
