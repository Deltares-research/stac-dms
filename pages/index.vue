        ...
        <div class="grid grid-cols-1 justify-center p-5  size-full...">
            <div>
                <div class="relative w-full max-w-sm items-center">
                    <Input id="search" type="text" placeholder="Search in title or description..." class="pl-10"/>
            ...
            <Card>
                ...
                <CardContent>
                    <div class="grid grid-cols-4 justify-center p-1  size-full...">
                        ...
                        <div>
                            <Checkbox id="GeoCentrifuge"/>
                            <Label class="m-2" for="GeoCentrifuge">Another one to fill the board</Label>
                        </div>
                        <div>
                            <Checkbox id="GeoCentrifuge"/>
            ...
            <Card>
                ...
                <CardContent>
                    <div class="grid grid-cols-[25%_75%] text-xs">
                        ...
                        <Label class="text-xs" for="name">P:\geocentrifuge\11206575-019 - Geolab FIM</Label>
