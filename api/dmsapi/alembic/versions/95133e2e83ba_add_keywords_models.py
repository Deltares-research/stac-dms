...
def upgrade() -> None:
    ...
    sa.Column('group_id', sqlmodel.GUID(), nullable=True),
    sa.Column('id', sqlmodel.GUID(), nullable=False),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.Column('facility_id', sqlmodel.GUID(), nullable=False),
    sa.Column('keyword_group_id', sqlmodel.GUID(), nullable=False),
